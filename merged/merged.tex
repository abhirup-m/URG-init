...
\bf{\Huge{Unitary Renormalization Group Approach to the Hubbard Dimer and Anderson Molecule}}\\
	...
	\vspace{50pt}
	\bf{\Large{IPhD. 4\uu{th} Semester Project Report}}\\
	\vspace{20pt}
...
\fr{U}{2}\begin{pmatrix} 1 & -1 \\ -1 & 1 \end{pmatrix} &\implies 0,\fr{U}{2} \implies \ket{\ua,\da}\pm\ket{\da,\ua}\\
...
In terms of these operators, the Hubbard Hamiltonian becomes
\beq
\ham = t\sum_\sigma\rr{\hat n_{\pi,\sigma}-\hat n_{0,\sigma}}+\fr{U}{2}\prod_\sigma \qq{\hat n_{0,\sigma}+\hat n_{\pi,\sigma}} + \fr{U}{2}\prod_\sigma \qq{c^\dagger_{0,\sigma}c_{\pi,\sigma}+c^\dagger_{\pi,\sigma}c_{0,\sigma}}
\eeq
