...
\eta^\dagger_{1\ua} &= G_e c_{1\ua}^\dagger T = -t \hat G_e c^\dagger_{1\ua}c_{2\ua} = -t (\ham^\prime_{1\ua} -H_e \hat n_{})^{-1}c^\dagger_{1\ua}c_{2\ua}\\
\tf \eta_{1\ua} &= -t c^\dagger_{2\ua}c_{1\ua}(\ham^\prime_{1\ua} -H_e \hat n_{})^{-1}  \\
\eta_{1\ua}^\dagger\eta_{1\ua} &= \hat n_{1\ua} \implies t^2(1-\nc) = (\ham^\prime_{1\uparrow}-H_e \hat n_{1\ua})^2\hat n_{1\ua} \implies \ham^\prime_{1\uparrow}\hat n_{1\ua} = H_e\hat n_{1\ua} + t(1-\hat n_{2\ua})\hat n_{1\ua}
\eeq
\beq
...
\btc
\beq
E_{\nb} = U(\nc\nd + 1) +2t(1 -\nd) = \begin{pmatrix} 2U & & & \\ & U+2t & & \\ & & U & \\ & & & U+2t \end{pmatrix}
\eeq
\etc
...
\beq
\bra{1}G_e^{-1}\ket{1} &= \bra{1}\ham^\prime_{1\da} - H_e\nb\ket{1} = \bra{1} \ham^\prime_{1\da}\nb - H_e \nb\ket{1} = t(1-\nd)\\
...
\begin{tabular}{ c| c| c| c| c }
        ...
        \hline
        1 & 1 & 1 & \(\ket{111}\) & 2U \\
        1 & 1 & 0 & \(\ket{110}+\ket{011}\) & U+2t \\
        1 & 0 & 1 & \(\ket{101}\) & U \\
        1 & 0 & 0 & \(\ket{100}+\ket{001}\) & U+2t \\
        0 & 1 & 1 & \(\ket{011}-\ket{110}\) & U-t \\
        0 & 1 & 0 & \(\ket{010}\) & 0 \\
        0 & 0 & 1 & \(\ket{001}-\ket{100}\) & 0 \\
        0 & 0 & 0 & \(\ket{000}\) & -t \\
\end{tabular}
\end{center}
...
\begin{tabular}{c|c| c| c| c | c| c }
        ...
        1 & 1 & 1 & 0 & \(\ket{1110}+\ket{1011}\) & Y & U+2t(U-t) \\
        1 & 1 & 0 & 1 & \(\ket{1101}-\ket{0111}\) & Y & U(U+t) \\
        1 & 1 & 0 & 0 & \(\ket{1100}+\ket{1001}-\ket{0110}-\ket{0011}\) & N &  U+2t(U+t) \\
        1 & 0 & 1 & 1 & \(\ket{1011}-\ket{1110}\) & Y & U-t(...) \\
        1 & 0 & 1 & 0 & \(\ket{1010}\) & Y & 0(same) \\
        1 & 0 & 0 & 1 & \(\ket{1001}-\ket{1100}-\ket{0011}+\ket{0110}\) & N & 0(...) \\
