...
\newcommand{\head}[1]{
\centerline{\begin{tcolorbox}[colback=mygr,colframe=gray,width=14.2in,halign=center]
\vspace{10pt}
...
\begin{tcolorbox}[halign=center, colback=white, colframe=red]
	...
	\il{\pmb{\eta^\dagger = \rr{\hat E - \hat H_h}^{-1}T^\dagger c}}\\\vspace*{20pt}
\end{tcolorbox}
\end{minipage}
...
\begin{center}\bf{\Large{First step: Determine the working equation}}\end{center}
...
\begin{minipage}[c]{\textwidth/2}
	...
	\\
	\bf{Also, \il{\pmb{H_e = }}\\\il{\\ \pmb{Un_{1\da}-Un_{2\ua}n_{2\da}+t(\ce^\dagger\cb+\cb^\dagger\ce)}}}\\\\\\
...
\centerline{\begin{tcolorbox}[colback=white, colframe=green, halign=center, width=200pt, height=50pt]
	\il{\pmb{\ham = \ham_0 + V}}
\end{tcolorbox}}
\begin{center} \Bigg \downarrow \end{center}
\centerline{\begin{tcolorbox}[colback=white, colframe=green, halign=center, width=350pt]
